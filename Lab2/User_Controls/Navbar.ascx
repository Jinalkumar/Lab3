...
<nav class="navbar navbar-inverse" role="navigation">
    <div class="container-fluid">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="Default.aspx"><i class="fa fa-graduation-cap fa-lg"></i> Contoso Univercity</a>
        </div>
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav navbar-right">
                ...
                <li id="departments" runat="server"><a href="Departments.aspx"><i class="fa fa-sitemap fa-lg"></i> Departments</a></li>
